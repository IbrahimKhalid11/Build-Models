...
//    ofstream dataFile("Dat/BarPlot To T.dat");
//    map<string, int>m = obj.value_counts(df, "T");
//    for (auto pair : m) {
...
//        "set output 'Visualization/BarPlot_To_T.png'; "
...
//        "plot 'Dat/BarPlot To T.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To T" << endl;
//
//}
