...
//    ofstream dataFile("Dat/Barplot between label and syn_flag.dat");
//    map<string, map<string, int>>m;
//
//    for (int j = 1; j < df.size(); j++) {
//        string Label = df[j][46];
//        string syn_flag = df[j][8];
//        m[Label][syn_flag]++;
//    }
//
...
//        "set output 'Visualization/Barplot between label and syn_flag.png'; "
//        "set style data histograms; "
//        "set style fill solid; "
//        "set boxwidth 0.8; "
//        "set title 'Bar Chart Example'; "
//        "set ylabel 'Values'; "
//        "set xlabel 'label and syn_flag'; "
//        "plot 'Dat/Barplot between label and syn_flag.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To label and syn_flag'" << endl;
//
//}
