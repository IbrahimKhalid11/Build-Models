...
//    ofstream dataFile("Dat/Barplot between label and TCP.dat");
...
//    system("gnuplot -e \"set terminal pngcairo size 1600,1000; "
//        "set output 'Visualization/Barplot between label and TCP.png'; "
//        "set style data histograms; "
//        "set style fill solid; "
//        "set boxwidth 0.8; "
//        "set title 'Bar Chart Example'; "
//        "set ylabel 'Values'; "
//        "set xlabel 'label and TCP'; "
//        "plot 'Dat/Barplot between label and TCP.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To label and TCP'" << endl;
//
//}
