...
//    ofstream dataFile("Dat/BarPlot To gillcolor.dat");
//    map<string, int>m = obj.value_counts(df, "gill-color");
//    for (auto pair : m) {
...
//        "set output 'Visualization/BarPlot_To_gillcolor.png'; "
...
//        "plot 'Dat/BarPlot To gillcolor.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To gillcolor'" << endl;
//
//}
