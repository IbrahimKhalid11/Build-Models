...
//    ofstream dataFile("Dat/Barplot between Target and gill_color.dat");
//    map<string, map<string, int>>m;
//
//    for (int j = 1; j < df.size(); j++) {
//        string gill_color = df[j][3];
...
//        "set output 'Visualization/Barplot between Target and gill_color.png'; "
//        "set style data histograms; "
//        "set style fill solid; "
//        "set boxwidth 0.8; "
//        "set title 'Bar Chart Example'; "
//        "set ylabel 'Values'; "
//        "set xlabel 'Target and gill_color'; "
//        "plot 'Dat/Barplot between Target and gill_color.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To Target and gill_color'" << endl;
//
//}
