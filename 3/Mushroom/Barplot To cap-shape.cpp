...
//    ofstream dataFile("Dat/BarPlot To cap-shape.dat");
//    map<string,int>m=obj.value_counts(df,"cap-shape");
//    for (auto pair: m) {
...
//           "set output 'Visualization/BarPlot_To_cap-shape.png'; "
...
//           "plot 'Dat/BarPlot To cap-shape.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To cap-shape" << endl;
//
//}
