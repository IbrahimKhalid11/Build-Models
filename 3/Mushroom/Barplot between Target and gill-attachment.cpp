...
//    ofstream dataFile("Dat/Barplot between Target and gill_attachment.dat");
//    map<string, map<string, int>>m;
//
//    for (int j = 1; j < df.size(); j++) {
//        string gill_attachment = df[j][2];
//        string Target = df[j][8];
//        m[gill_attachment][Target]++;
//    }
//
...
//        "set output 'Visualization/Barplot between Target and gill_attachment.png'; "
//        "set style data histograms; "
//        "set style fill solid; "
//        "set boxwidth 0.8; "
//        "set title 'Bar Chart Example'; "
//        "set ylabel 'Values'; "
//        "set xlabel 'Target and gill_attachment'; "
//        "plot 'Dat/Barplot between Target and gill_attachment.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To Target and gill_attachment'" << endl;
//
//}
