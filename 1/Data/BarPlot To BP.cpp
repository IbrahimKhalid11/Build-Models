...
//    ofstream dataFile("Dat/BarPlot To BP.dat");
//    map<string, int>m = obj.value_counts(df, "BP");
//    for (auto pair : m) {
...
//        "set output 'Visualization/BarPlot_To_BP.png'; "
...
//        "plot 'Dat/BarPlot To BP.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To BP'" << endl;
//
//}
