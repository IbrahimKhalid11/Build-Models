...
//    ofstream dataFile("Dat/BarPlot To Drug.dat");
//    map<string,int>m=obj.value_counts(df,"Drug");
//    for (auto pair: m) {
...
//           "set output 'Visualization/BarPlot_To_Drug.png'; "
...
//           "plot 'Dat/BarPlot To Drug.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To Drug'" << endl;
//
//}
