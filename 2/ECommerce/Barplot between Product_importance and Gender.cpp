...
//    ofstream dataFile("Dat/Barplot between Gender and Product_importance.dat");
//    map<string, map<string, int>>m;
//
//    for (int j = 1; j < df.size(); j++) {
//        string gender = df[j][8];
//        string Product_importance = df[j][7];
//        m[Product_importance][gender]++;
//    }
//
...
//        "set output 'Visualization/Barplot between Gender and Product_importance.png'; "
//        "set style data histograms; "
//        "set style fill solid; "
//        "set boxwidth 0.8; "
//        "set title 'Bar Chart Example'; "
//        "set ylabel 'Values'; "
//        "set xlabel 'Gender and Product_importance'; "
//        "plot 'Dat/Barplot between Gender and Product_importance.dat' using 2:xtic(1) title 'Bar Chart';\"");
//
//    cout << "Bar chart plotted as 'BarPlot To Gender and Product_importance'" << endl;
//
//}
